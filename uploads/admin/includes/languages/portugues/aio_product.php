...
define('TAB_TITLE_PRODUCT_IMAGES', 'Imagens');
define('TAB_TITLE_PRODUCT_OPTIONS', 'Op&ccedil;&otilde;es do Produto');
define('TAB_TITLE_PRODUCT_ATTRIBUTES', 'Atributos');
define('TAB_TITLE_FILE_MANAGER', 'Gerenciador de Arquivos');

define('TAB_TEXT_PRODUCT_IMAGES', 'Imagens do Produto');
define('TAB_TEXT_PRODUCT_DEFAULT_IMAGE', 'Imagem Padr&atilde;o do Produto:');  
define('TAB_TEXT_UPLOAD_MAIN_DIRECTORY', 'Diret&oacute;rio Padr&atilde;o');  
define('TAB_TEXT_UPLOAD_IMAGE', 'Imagem:');
define('TAB_TEXT_UPLOAD_FILE', 'Arquivo:');
define('TAB_TEXT_UPLOAD_PENDING', 'Pendente');
define('TAB_TEXT_UPLOAD_SIZE_LIMIT', 'O tamanho do arquivo %s &eacute; maior que o limite');
define('TAB_TEXT_UPLOAD_IMAGE_FILES', 'Arquivos de imagens');
define('TAB_TEXT_UPLOAD_UPLOADING', 'Enviando...');
define('TAB_TEXT_UPLOAD_OVERWRITE', 'Sobrescrever:');
define('TAB_TEXT_DELETE_IMAGE_WARNING', 'Tem certeza que deseja excluir a imagem %s?');
define('TAB_TEXT_DELETE_PRIMARY_IMAGE_WARNING', 'Tem certeza que deseja excluir a imagem principal?');
define('TAB_TEXT_CHANGE_DIR_WARNING', 'Alterar o diret&oacute;rio depois que uma imagem j&aacute; foi enviada,\nvoc&ecirc; perder&aacute; o v&iacute;nculo da imagem.\nTem certeza que deseja fazer isto?');

define('TABLE_HEADING_ID', 'ID');
define('TABLE_HEADING_OPT_NAME', 'Nome da Op&ccedil;&atilde;o');
define('TABLE_HEADING_OPT_VALUE', 'Valor da Op&ccedil;&atilde;o');
define('TABLE_HEADING_OPT_SORT_ORDER', 'Ordem');
define('TABLE_HEADING_OPT_MAX_DAYS', 'Expira em');
define('TABLE_HEADING_OPT_MAX_COUNT', 'Contagem de Download');
define('TABLE_HEADING_OPT_FILE', 'Arquivo');
define('TABLE_HEADING_VALID', 'V&aacute;lida&ccedil;&atilde;o');
define('TABLE_HEADING_OPT_ACTION', 'A&ccedil;&atilde;o');

define('UPDATE_N_RELOAD', 'Atualizar e Voltar');
define('INSERT_N_RELOAD', 'Inserir e Voltar');

define('TEXT_RELOAD_IMAGE_LIST', 'Atualizar Lista de Imagens');
define('TEXT_ACTIONS', 'A&ccedil;&otilde;es');
define('TEXT_NAME', 'Nome');
define('TEXT_IMAGE', 'Imagem');

define('TEXT_CHOOSE_IMAGE', 'Escolher Imagem');
define('TEXT_UPLOAD_IMAGES', 'Enviar Imagens');
define('TEXT_DATE_FORMAT', '(AAAA-MM-DD)');
define('TEXT_NEW_ATTRIBUTE', 'Novo Atributo');
define('TEXT_ADD', 'Adicionar');
define('TEXT_RELOAD', 'Atualizar');
define('TEXT_ATTRIBUTES_LIST', 'Lista de Atributos');
define('TEXT_RELOAD_ATTRIBUTES_LIST', 'Atualizar Lista de Atributos');
define('TEXT_DELETE_ALL_ATTRIBUTES', 'Excluir Todos os Atributos');
define('TEXT_SAVE_PRODUCT_FIRST', 'Voc&ecirc; precisa salvar o produto primeiro.');
define('TEXT_DELETE_ITEMS', 'Tem certeza que deseja excluir o(s) item(s) abaixo?');
define('TEXT_TEXT_WARNING_UNDONE', 'Aviso: Isto n&atilde;o pode ser desfeito.');