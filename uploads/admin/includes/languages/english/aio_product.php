...
define('TAB_TITLE_PRODUCT_IMAGES', 'Images');
define('TAB_TITLE_PRODUCT_OPTIONS', 'Product Options');
define('TAB_TITLE_PRODUCT_ATTRIBUTES', 'Attributes');
define('TAB_TITLE_FILE_MANAGER', 'File Manager');

define('TAB_TEXT_PRODUCT_IMAGES', 'Product Images');
define('TAB_TEXT_PRODUCT_DEFAULT_IMAGE', 'Product Default Image:');  
define('TAB_TEXT_UPLOAD_MAIN_DIRECTORY', 'Main Directory');  
define('TAB_TEXT_UPLOAD_IMAGE', 'Image:');
define('TAB_TEXT_UPLOAD_FILE', 'File:');
define('TAB_TEXT_UPLOAD_PENDING', 'Pending');
define('TAB_TEXT_UPLOAD_SIZE_LIMIT', 'Size of the file %s is greater than limit');
define('TAB_TEXT_UPLOAD_IMAGE_FILES', 'Image files');
define('TAB_TEXT_UPLOAD_UPLOADING', 'Uploading...');
define('TAB_TEXT_UPLOAD_OVERWRITE', 'Overwrite if exist:');
define('TAB_TEXT_DELETE_IMAGE_WARNING', 'Are you sure that you want to delete the image %s?');
define('TAB_TEXT_DELETE_PRIMARY_IMAGE_WARNING', 'Are you sure that you want to delete the primary image?');
define('TAB_TEXT_CHANGE_DIR_WARNING', 'Changing the directory after a image has been already uploaded,\nyou will cause you to lose the track of the images that is on the current.\nAre you sure that you want to do that?');
...
define('TABLE_HEADING_OPT_MAX_DAYS', 'Expiry Days');
define('TABLE_HEADING_OPT_MAX_COUNT', 'Download Count');
define('TABLE_HEADING_OPT_FILE', 'File');
define('TABLE_HEADING_VALID', 'Valid');
define('TABLE_HEADING_OPT_ACTION', 'Action');

define('UPDATE_N_RELOAD', 'Update and Back');
define('INSERT_N_RELOAD', 'Insert and Back');

define('TEXT_RELOAD_IMAGE_LIST', 'Reload Image List');
define('TEXT_ACTIONS', 'Actions');
define('TEXT_NAME', 'Name');
define('TEXT_IMAGE', 'Image');

define('TEXT_CHOOSE_IMAGE', 'Choose Image');
define('TEXT_UPLOAD_IMAGES', 'Upload Images');
define('TEXT_DATE_FORMAT', '(YYYY-MM-DD)');
define('TEXT_NEW_ATTRIBUTE', 'New Attribute');
define('TEXT_ADD', 'Add');
define('TEXT_RELOAD', 'Reload');
define('TEXT_ATTRIBUTES_LIST', 'Attributes List');
define('TEXT_RELOAD_ATTRIBUTES_LIST', 'Reload Attributes List');
define('TEXT_DELETE_ALL_ATTRIBUTES', 'Delete All Attributes');
define('TEXT_SAVE_PRODUCT_FIRST', 'You must save the product first.');
define('TEXT_DELETE_ITEMS', 'Are you sure that you want to delete the item(s) below?');
define('TEXT_TEXT_WARNING_UNDONE', 'Warning: This cannot be undone.');